...
const FieldActivity = ({navigation}) => {
  return (
    <View style={styles.container}>
      ...
      {/* <View style={styles.header}>
        ...
        <View style={styles.two}>
          ...
          // this view no necerroy
          >23/09/56</Text>
          <View>
            <Icons
              name={'downcircle'}
              iconType={'AntDesign'}
              size={20}                     // this view no necerroy
              color="#f54900cc"
              // onPress={() => Alert.alert('Item Removed')}
            />
          </View>
      ...
      <View style={styles.main}>
        ...
        <View style={styles.mflistain1}>
          <View style={styles.inmflistain1}>
            <View>
              <Text style={styles.title21}>#Requirements Handled</Text>
            </View>
      ...
      <View style={styles.mflistain122}>
          <View style={styles.inmflistain1}>
            <View>
              <Text style={styles.title21}>Daily Summary</Text>
            </View>
            
          </View>

      
          <View style={styles.topne1ab}>
            <TextInput
              placeholder="Req Name"
              //   onChangeText={text => onChangeText(text)}
              //   value={value}
      ...
      <View style={{height:hp('10'),flexDirection:'row',alignSelf:'center',alignItems:'center'}}>
        ...
        <SubmitBtn1
          ...
          txtStyle={{color: '#350091', fontWeight: 'bold'}}
          label="CLEAR"
