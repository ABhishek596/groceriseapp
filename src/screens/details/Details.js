      ...
      <Pressable>
        <View style={styles.header}>
          <View style={styles.one}>
            ...
            <Text
              style={styles.title}
              onPress={() => navigation.navigate('DetailsSuccess')}>
              Details
            </Text>
          </View>
        ...
        <ScrollView style={styles.main} showsVerticalScrollIndicator={false}>
          <View style={styles.topheading}>
            <Text style={styles.topheadingtxt}>#Reqs Open As Of Today</Text>
          ...
          <View style={styles.mflistain}>
            ...
            <View style={styles.topne1}>
              ...
              <View style={styles.inside}>
                <Text style={styles.txt2}>ipsum</Text>
                <Text style={styles.txt3}>34</Text>
              </View>
            </View>
            <View style={styles.topne1}>
              <View style={styles.inside}>
                <Text style={styles.txt2}>in same</Text>
                <Text style={styles.txt3}>4</Text>
              </View>
              <View style={styles.inside}>
                <Text style={styles.txt2}>the majority</Text>
            ...
            <View style={styles.topne1}>
              <View style={styles.inside}>
                <Text style={styles.txt2}>lorem</Text>
                <Text style={styles.txt3}>23</Text>
              </View>
              <View style={styles.inside}>
                <Text style={styles.txt2}>lorem ips</Text>
                <Text style={styles.txt3}>32</Text>
              </View>
            </View>
            <View style={styles.topne1}>
              <View style={styles.inside}>
                <Text style={styles.txt2}>same to</Text>
                <Text style={styles.txt3}>56</Text>
              </View>
              <View style={styles.inside}>
                <Text style={styles.txt2}>have sur</Text>
                <Text style={styles.txt3}>45</Text>
              </View>
            </View>
          ...
          <View style={styles.mflistain1}>
            <View style={styles.inmflistain1}>
              <View>
                <Text style={styles.title21}>Requirements Notes</Text>
              </View>
              {/* <View>
  <Text style={styles.title3}>20/09/23</Text>
</View> */}
            ...
            <View style={styles.topne1}>
              <View style={styles.inside}>
                <Text style={styles.txt2}>There as</Text>
                <Text style={styles.txt3}>10</Text>
              </View>
              <View style={styles.inside}>
                <Text style={styles.txt2}>Lorem ip</Text>
                <Text style={styles.txt3}>34</Text>
              </View>
            </View>
            <View style={styles.topne1}>
              <View style={styles.inside}>
                <Text style={styles.txt2}>Lorem i</Text>
                <Text style={styles.txt3}>4</Text>
              </View>
              <View style={styles.inside}>
                <Text style={styles.txt2}>Passages</Text>
                <Text style={styles.txt3}>45</Text>
              </View>
            </View>
